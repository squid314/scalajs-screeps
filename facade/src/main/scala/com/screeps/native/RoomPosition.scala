...
trait RoomPosition extends js.Object {
     ...
     * @param name          optional, Name of the new structure, for structures that support it (currently only spawns).
     ...
     * @note CPU Cost: CONST
     */
    def createConstructionSite(structureType: String @@ StructureType, name: String = ""): Int @@ Error = js.native
     ...
     *
     * @param target The type of object to find, or an array of [[RoomObject]]s or [[RoomPosition]]s
